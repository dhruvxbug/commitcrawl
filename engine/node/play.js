...
function handleCommand(input) {
  ...
  if (input === "look") {
    ...
    console.log(inventory.length ? `You are carrying: ${inventory.map((i) => i.name).join(", ")}` : "You have nothing.");
  } else if (input === "help") {
    console.log("Commands: look, go <direction>, take <item>, use <item>, place <item>, fight, inventory, quit");
